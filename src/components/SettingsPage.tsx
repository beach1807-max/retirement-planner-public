  ...
  return (
    <div className="page-stack narrow-page">
      <section className="panel">
        <div className="panel-heading"><div><h2><CalculationHelp label="退休與預測假設" topic="legacyRetirement" /></h2><p>生活費以計算基準日的今天購買力輸入，系統會在月份時間軸中處理通膨。</p></div></div>
