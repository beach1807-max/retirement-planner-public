    ...
    <div className="page-stack narrow-page">
      <section className="panel">
        ...
        <form className="settings-form" onSubmit={submit}>
          ...
          <details className="advanced-settings"><summary>{UI_TERMS.retirementNeedsPlanning}資料（選填）</summary><div className="context-help-row"><CalculationHelp label="這些欄位用在哪裡？" topic="legacyRetirement" /><CalculationHelp label="規劃終點年齡" topic="planningEndAge" /></div><p className="muted">下列生活費、準備金、遺產與支出只供退休生活需求試算使用，不會從首頁未來資產預估中扣除。</p>
